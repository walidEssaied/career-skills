...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900">Course Analytics Report</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-800">Course Performance</h2>
        </div>
        <div class="p-6">
            <!-- Course analytics data will be displayed here -->
        </div>
    </div>
</div>
@endsection
...
document.addEventListener('DOMContentLoaded', function() {
    const ctx = document.getElementById('courseAnalyticsChart').getContext('2d');
    new Chart(ctx, {
        type: 'bar',
        data: {
            labels: [], // Will be populated with course names
            datasets: [] // Will be populated with course data
        },
        options: {
            responsive: true,
            scales: {
